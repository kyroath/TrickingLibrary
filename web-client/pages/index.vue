      ...
      <div v-for="t in tricks">
        ...
        <div>
          <video
            width="400"
            controls
            :src="`http://localhost:5000/api/videos/${t.video}`"
          ></video>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    ...mapMutations({ resetVideos: "videos/reset" }),
    ...mapActions({ createTrick: "tricks/createTrick" }),
    ...mapActions({ startVideoUpload: "videos/startVideoUpload" }),
